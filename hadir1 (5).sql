...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 26, 2024 at 02:31 AM
...
--
ALTER TABLE `aktiviti`
  MODIFY `kod` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `hadir`
--
ALTER TABLE `hadir`
  MODIFY `bil` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
